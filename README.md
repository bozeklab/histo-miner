...
⚠️ Contrary to NucSeg, TumSeg, SCC Hovernet and SCC Segmenter weights, **CPI dataset remains restricted*** until the paper is published in a journal. The dataset was publicly available few days after publication of the preprint but was made private again after discussion and agreement with co-authors. 
